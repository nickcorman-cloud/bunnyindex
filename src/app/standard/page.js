  ...
  return (
    <EditorialShell>
      ...
      />
        ...
        <p style={p}>
          If a fund or a company holds a stake that does not confer control, that is not an automatic fail. We look at who can actually set policy. A controlling parent that tests fails. A non-controlling stake does not, on its own. If control is unclear, the brand stays off the list until it isn’t.
        </p>
