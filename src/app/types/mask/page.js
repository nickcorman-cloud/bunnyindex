...
export default function HubPage() {
  return (
    <IngredientPage
      ...
      sections={[
        {
          heading: 'What it is',
          paragraphs: [
            "This page is the catalog’s Mask type, with the standard already applied. It is not a cleanser, not a leave-on treatment, and not a spa routine.",
          ],
        },
        {
      ...
      closing="Mask is the filter. The standard is the company. We list both, or we list nothing."
    />
  );
}
