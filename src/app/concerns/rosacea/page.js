...
export default function HubPage() {
  return (
    <IngredientPage
      tag="Rosacea"
      eyebrow="Concern"
      h1="Rosacea, from brands that actually pass."
      kind="concern"
      dek="Rosacea-tagged products from brands that meet all three rules \u2014 not a treatment plan."
      sections={[
        {
          heading: 'What it is',
          paragraphs: [
            "This page is the catalog\u2019s Rosacea tag, with the standard already applied. It is not a diagnosis, and it is not a routine.",
      ...
      closing="Rosacea is the filter. The standard is the company. We list both, or we list nothing."
    />
  );
}
