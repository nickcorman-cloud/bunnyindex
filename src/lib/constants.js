...
export const BRAND_PROFILES = [
  ...
  { name: 'Good Molecules', blurb: 'Good Molecules was built to close the gap between clinical-grade ingredients and accessible pricing. Their serums, toners, and treatments pack actives like niacinamide, glycolic acid, and tranexamic acid into no-frills packaging at prices that make it easy to use them consistently — which is the whole point.' },
  ...
  { name: 'Supergoop', blurb: 'Supergoop built a brand on a single conviction: nobody was using enough sunscreen, and most formulas gave people a good reason not to. They reformulated SPF to be lightweight, blendable, and something people actually want to apply — and in doing so, almost singlehandedly made daily sun protection a skincare category of its own. Cruelty-free throughout.' },
