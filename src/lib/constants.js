...
export const BRAND_PROFILES = [
  ...
  { name: 'Good Molecules', blurb: 'Good Molecules was built to close the gap between clinical-grade ingredients and accessible pricing. Their serums, toners, and treatments pack activeslike niacinamide, glycolic acid, and tranexamic acid into no-frills packaging at prices that make it easy to use them consistently — which is the whole point.' },6
  },  
